...
public class InfoService {
	...
	public List<InfoDTO> listAll() {
		try {
			...
			throw new ErroExceptionsObjectMessage("Error listing information, please try again.");
		}
	}
	...
	public void ValidValueDuplicate(InfoDTO infoDto) {
		...
		if(findinfo != null && findinfo.getId() != infodto.getId()) {
			throw new ErroExceptionsObjectMessage("The following information about the film is already registered in the database, please try to insert another film.");
		}
	}
}
